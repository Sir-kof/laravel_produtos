        ...
        <div class="modal-content">
            <form class="form-horizontal" id="formProduto">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="quantidadeProduto" class="control-label">Quantidade de Produtos</label>
                        <div class="input-group">
                            <input type="number" class="form-control" id="quantidadeProduto" placeholder="Quantidade de Produtos">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (e) {
                    ...
                    e[0].cells[3].textContent = prod.preço;
